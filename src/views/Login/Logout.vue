            ...
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                <div class="text-center"><img class="d-block mx-auto mb-4" src="../../assets/img/icons/spot-illustrations/45.png" alt="shield" width="100" />
                  <h4>期待下次再见！</h4>
                  <p>感谢您对我们健康大数据研究中心的支持</p><a class="btn btn-primary btn-sm mt-3" @click="goToLogin"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>返回登录</a>
                </div>
              </div>
            </div>
          </div>
