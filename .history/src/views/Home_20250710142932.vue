      ...
      <div class="container">
        <div class="row flex-center pt-8 pt-lg-10 pb-lg-9 pb-xl-0">
          <div class="col-md-11 col-lg-8 col-xl-4 pb-7 pb-xl-9 text-center text-xl-start">
            ...
            <p class="lead text-primary opacity-75">欢迎来到健康大数据研究中心</p><a class="btn btn-outline-light border-2 rounded-pill btn-lg mt-4 fs-9 py-2" href="#!">开始吧!<span class="fas fa-play ms-2" data-fa-transform="shrink-6 down-1"></span></a>
          </div>
