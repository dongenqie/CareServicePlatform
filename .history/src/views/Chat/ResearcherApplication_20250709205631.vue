...
// 路由跳转方法
function goToDashboard() { router.push({ name: 'ResearcherDashboard' }) }
function goToDataAnalysis() { router.push({ name: 'DataAnalysis' }) }
function goToMyApplications() { router.push({ name: 'ResearcherApplication' }) }
