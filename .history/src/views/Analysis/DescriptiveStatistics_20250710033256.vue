                        ...
                        <div class="card-body">
                          <transition name="fade" @before-enter="beforeEnter" @enter="enter" @leave="leave">
                            <div v-if="analysisResults" class="text-center">
                              <p>经分析，数据的中位数为 <strong>{{ median }}</strong></p>
                              <p>平均值为 <strong>{{ average }}</strong></p>
                              <p>标准差为 <strong>{{ stdDev }}</strong></p>
                              <p>符合 <strong>{{ normal ? '正太分布' : '非正太分布' }}</strong></p>
                              <p>符合 <strong>{{ index ? '指数分布' : '非指数分布' }}</strong></p>
                            </div>
                          </transition>
                        </div>
                      </div>
