                ...
                <div class="row g-1">
                  ...
                  <div class="col-xxl-9">
                    <div class="tab-content">
                      <!-- Find the JS file for the following chart at: src/js/charts/echarts/crm-revenue.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js-->
            ...
            <div class="row g-3">
              <div class="card mb-3">
                ...
                <div class="card-bottom">
                  <button class="btn btn-link text-600 btn-sm btn-reveal" type="button">提交</button>
                </div>
              </div>
            </div>
          </div>
