<script setup>
import { onMounted, ref, onUnmounted, computed, component } from 'vue'
              ...
              <div class="card-body bg-body-tertiary">
                <div class="tab-content">
                  <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-1909abd0-ff88-40e6-bbb7-500c49b602a0" id="dom-1909abd0-ff88-40e6-bbb7-500c49b602a0">
                    <div class="echart-scatter-quartet-chart-example" style="min-height: 450px;" data-echart-responsive="true"></div>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <form 
                    ...
                    <div class="row g-3">
                      <div class="col-sm-12">
                        ...
                        <input class="form-control" id="directTime" type="text" placeholder="directTime">
                      </div>
                    </div>
