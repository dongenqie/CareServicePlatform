...
const submitFile = async () => {
  ...
  try {
    const data = await getDescriptiveStatistics(file.value);
...
// 更新图表
const updateChart = () => {
  const chartEl = document.querySelector(".echart-analysis-descriptive");
  if (!chartEl) return;
  ...
  const options = {
    ...
    xAxis: {
      type: 'category',
      data: histogramData.value.xaxis
    },
    yAxis: {
      type: 'value'
    },
                  ...
                  <div class="col-xxl-9">
                    <div class="tab-content">
                      <div class="tab-pane active" id="analysis-descriptive" role="tabpanel" aria-labelledby="analysis-descriptive-tab">
                        <div class="echart-analysis-descriptive" data-echart-responsive="true" data-echart-tab="data-echart-tab" style="height:320px;"></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body bg-body-tertiary">
                  <form class="dropzone dropzone-multiple p-0" id="my-awesome-dropzone" data-dropzone="data-dropzone" action="#!">
                    <div class="fallback">
                      <input name="file" type="file" multiple="multiple" @change="handleFileChange" /></div>
