...
async function submitFile() {
  ...
  try {
    ...
    if (data && data.boxPlotVO1 && data.boxPlotVO2) {
      ...
      changeResult.value = comparativeData.horizonVO.changeResult;
      meanResult.value = comparativeData.horizonVO.meanResult;
      // 设置分析结果可见
                        ...
                        <div class="card-body">
                          <transition name="fade" @before-enter="beforeEnter" @enter="enter" @leave="leave">
                            <div v-if="analysisResults" class="text-center">
                              <p class="text-white">经分析，{{ meanResult }},与因变量{{ correlationData.name2 }}的相关系数为 <strong>{{ correlationData.correlation }}</strong>, <strong>{{ correlationData.conform ? '呈' : '非' }}</strong> 线性相关</p>
                            </div>
                          </transition>
                        </div>
                      </div>
        ...
        <footer class="footer">
          <div class="row g-0 justify-content-between fs-10 mt-4 mb-3">
            <div class="col-12 col-sm-auto text-center">
              <p class="mb-0 text-600">感谢您对我们健康大数据研究中心的支持<span class="d-none d-sm-inline-block">| </span><br class="d-sm-none" /> 2025 &copy; <a href="https://themewagon.com">网页样式参考bootstrap-falcon</a></p>
            </div>
            <div class="col-12 col-sm-auto text-center">
