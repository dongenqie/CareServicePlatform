                        ...
                        <div class="card-body">
                          <transition name="fade" @before-enter="beforeEnter" @enter="enter" @leave="leave">
                            <div v-if="analysisResults" class="text-center">
                              <p class="text-white">经分析，数据的中位数为 <strong>{{ median }}</strong>,平均值为 <strong>{{ average }}</strong>,标准差为 <strong>{{ stdDev }}</strong>,符合 <strong>{{ normal ? '正太分布' : '非正太分布' }}</strong>,符合 <strong>{{ index ? '指数分布' : '非指数分布' }}</strong></p>
                            </div>
                          </transition>
                        </div>
                      </div>
          ...
          <div class="col-sm-6 col-md-2">
            <div class="card overflow-hidden" style="min-width: 12rem">
              ...
              <div class="card-body position-relative">
                ...
                <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-warning" data-countup="{&quot;endValue&quot;:0,&quot;decimalPlaces&quot;:2,&quot;}">{{ average }}</div>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-2">
            <div class="card overflow-hidden" style="min-width: 12rem">
              ...
              <div class="card-body position-relative">
                ...
                <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-info" data-countup="{&quot;endValue&quot;:0,&quot;decimalPlaces&quot;:2,&quot;}">{{ median }}</div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card overflow-hidden" style="min-width: 12rem">
              ...
              <div class="card-body position-relative">
                ...
                <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif" data-countup="{&quot;endValue&quot;:0,&quot;}">{{ stdDev }}</div>
              </div>
            </div>
          </div>
        </div>  
