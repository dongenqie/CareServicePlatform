                ...
                <div class="row flex-between-end">
                  ...
                  <div class="col-auto ms-auto">
                    <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                      ...
                      <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-4bf4e820-b0f1-4aeb-9a71-35f41044c68c" type="button" role="tab" aria-controls="dom-4bf4e820-b0f1-4aeb-9a71-35f41044c68c" aria-selected="false" id="tab-dom-4bf4e820-b0f1-4aeb-9a71-35f41044c68c">Code</button>
                    </div>
                  </div>
                </div>
              </div>
              <div class="card-body bg-body-tertiary">
                <div class="tab-content">
                  <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-1909abd0-ff88-40e6-bbb7-500c49b602a0" id="dom-1909abd0-ff88-40e6-bbb7-500c49b602a0">
                    <!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/scatter-quartet.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js-->
