...
const curveData = ref({});
Dropzone.autoDiscover = false; // 禁止自动初始化
...
const submitFile = async () => {
  const myDropzone = new Dropzone("#my-awesome-dropzone", {
    url: "your-upload-url",  // 上传 URL
    paramName: "file",       // 文件字段名称
    maxFilesize: 2,          // 最大文件大小 2MB
    acceptedFiles: ".csv,.json,.xlsx",  // 只接受的文件格式
    addRemoveLinks: true     // 添加删除文件链接
  });
