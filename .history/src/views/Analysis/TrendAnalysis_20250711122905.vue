                        ...
                        <div class="card-body">
                          <transition name="fade" @before-enter="beforeEnter" @enter="enter" @leave="leave">
                            <div v-if="analysisResults" class="text-center">
                              <p class="text-white">经分析，自变量{{ attributeName1 }}对因变量{{ attributeName2 }}的影响强度为<strong>{{ trendData.strength }}</strong>, 整体呈<strong>{{ trendData.trend }}</strong>趋势，预测值为<strong>{{ trendData.prediction }}</strong></p>
                            </div>
                          </transition>
                        </div>
                      </div>
