                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body bg-body-tertiary">
                    <form 
                      ...
                      <div class="row g-3">
                        <div class="col-sm-6">
                          <label class="form-label" for="event-city">自变量</label>
                          <input class="form-control" id="event-city" type="text" placeholder="attribute Name1">
                        </div>
                        <div class="col-sm-6">
                          <label class="form-label" for="event-city">因变量</label>
                          <input class="form-control" id="event-city" type="text" placeholder="attribute Name2">
                        </div>
                      </div>
