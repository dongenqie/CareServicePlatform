                    ...
                    <form 
                      ...
                      <div class="row g-3">
                        <div class="col-sm-6">
                          ...
                          <input class="form-control" id="attribute-Name1" type="text" placeholder="attriName1">
                        </div>
                        <div class="col-sm-6">
                          <label class="form-label" for="attribute-Name2">因变量</label>
                          <input class="form-control" id="attribute-Name2" type="text" placeholder="attriName2">
                        </div>
                      </div>
