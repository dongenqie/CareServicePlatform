              ...
              <div class="card-header">
                <div class="row flex-between-end">
                  <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor">趋势分析展示图</h5>
                  </div>
                        ...
                        <div class="card-body">
                          <transition name="fade" @before-enter="beforeEnter" @enter="enter" @leave="leave">
                            <div v-if="analysisResults" class="text-center">
                              <p class="text-white">经分析，自变量{{ attributeName1 }}对因变量{{ attributeName2 }}的影响强度为<strong>{{ trendData.strength }}</strong>, 整体呈<strong>{{ trendData.trend }}</strong>趋势，{{directTime}}年的预测值为<strong>{{ trendData.prediction }}</strong></p>
                            </div>
                          </transition>
                        </div>
                      </div>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body bg-body-tertiary">
                  <form 
                    ...
                    <div class="row g-3">
                      <div class="col-sm-12">
                        <label class="form-label" for="attribute-Name1">预测
                          <span class="ms-1 text-400" data-bs-toggle="tooltip" data-bs-placement="top" title="请在此输入您需要预测的数据，如年份、年龄等，注意是数值哦~">
                            <span class="far fa-question-circle" data-fa-transform="shrink-1"></span>
                          </span>
                        </label>
                        <input class="form-control" id="directTime" v-model="directTime" type="number" placeholder="预测">
                      </div>
                    </div>
