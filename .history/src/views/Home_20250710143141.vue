...
<template>
  ...
  <main class="main" id="top">
    ...
    <section class="py-0 overflow-hidden" id="banner" data-bs-theme="light">
      <div class="bg-holder" style="background-image:url(https://www.zkj.com/Public/Uploads/uploadfile/images/20230825/weixintupian_20230825155201.png);background-position: center bottom;"></div><!--/.bg-holder-->
      <div class="container">
