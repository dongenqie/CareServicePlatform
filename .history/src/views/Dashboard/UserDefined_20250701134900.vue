...
const dashboardModules = ref([
  { id: 1, title: 'Module 1', value: '$47K', row: 1, col: 1 },
  { id: 2, title: 'Module 2', value: '$30K', row: 1, col: 2 },
  { id: 3, title: 'Module 3', value: '$15K', row: 2, col: 1 },
  { id: 4, title: 'Module 4', value: '$10K', row: 2, col: 2 },
]);
...
const draggableOptions = ref({
  group: 'dashboard',
  disabled: !isEditing.value,  // 根据 isEditing 控制是否启用拖拽
});

// 获取模块样式，控制其在网格中的位置和大小
function getItemStyle(element) {
  return {
    gridRow: element.row,
...
function onMove(evt) {
  // 更新拖动后的模块位置
  const module = dashboardModules.value[evt.oldIndex];
  module.row = Math.floor(evt.newIndex / 2) + 1; // 基于简单计算设置新行
  module.col = (evt.newIndex % 2) + 1; // 设置新列
}
        ...
        <div class="content">
          ...
          <div class="row mb-3">
            ...
            <div class="dashboard">
                ...
                <button @click="enableDashboardEditing">编辑仪表盘</button>
                </div>
