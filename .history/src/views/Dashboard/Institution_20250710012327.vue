            ...
            <div class="card">
              ...
              <div class="card-footer bg-body-tertiary py-2">
                <div class="row flex-between-center">
                  ...
                  <div class="col-auto"><a class="btn btn-link btn-sm px-0 fw-medium" href="#!">概览<span class="fas fa-chevron-right ms-1 fs-11"></span></a></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card-header">
                <div class="row flex-between-center">
                  <div class="col-auto col-sm-6 col-lg-7">
                    <h6 class="mb-0 text-nowrap py-2 py-xl-0">首页预览</h6>
                  </div>
              ...
              <div class="card-body px-0 py-0">
                <div class="table-responsive scrollbar">
                  <table class="table fs-10 mb-0 overflow-hidden">
                    <thead class="bg-200">
                      <tr>
                        <th class="text-900 sort pe-1 align-middle white-space-nowrap" data-sort="path">页面路径</th>
                        <th class="text-900 sort pe-1 align-middle white-space-nowrap text-end" data-sort="views">页面预览</th>
                        <th class="text-900 sort pe-1 align-middle white-space-nowrap text-end" data-sort="time">平均页面时间</th>
                        <th class="text-900 sort pe-x1 align-middle white-space-nowrap text-end" data-sort="exitRate">退出率</th>
                      </tr>
                    </thead>
                    <tbody class="list">
