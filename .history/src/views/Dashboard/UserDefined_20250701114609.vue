...
const isEditing = ref(false) // 控制是否启用拖拽编辑模式

// 模拟数据模块
const dashboardModules = ref([
  { id: 1, title: 'Weekly Sales', value: 47000, changePercentage: '+3.5%', tooltip: 'Calculated according to last week's sales', tooltipText: 'Sales calculation based on last week', tooltipPosition: 'top', chartClass: 'echart-bar-weekly-sales' },
  { id: 2, title: 'Total Order', value: 58400, changePercentage: '+13.6%', tooltip: '', tooltipText: '', tooltipPosition: '', chartClass: 'echart-default-total-order' },
  { id: 3, title: 'Market Share', value: 0, changePercentage: '20%', tooltip: '', tooltipText: '', tooltipPosition: '', chartClass: 'echart-market-share' },
  { id: 4, title: 'Weather', value: 31, changePercentage: 'Sunny', tooltip: '', tooltipText: '', tooltipPosition: '', chartClass: '' }
])
    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <div class="content">
              ...
              <div class="card bg-100 shadow-none border">
                <div class="row gx-0 flex-between-center">
                  ...
                  <div class="col-md-auto p-3">
                    ...
                    <div class="col-auto"><a class="btn btn-sm btn-falcon-default" @click="enableDashboardEditing">编辑仪表盘</a></div>
                    </form>
                  </div>
                </div>
              </div>
          ...
          <!-- 使用vuedraggable包裹需要排序的模块 -->
            <draggable v-if="isEditing" :list="dashboardModules" :options="{ group: 'dashboard' }" class="row g-3 mb-3" item-key="id">
            <template v-for="module in dashboardModules">
                <!-- 数据模块1 -->
                <div :key="module.id" class="col-md-6 col-xxl-3">
                <div class="card h-md-100 ecommerce-card-min-width">
                    <div class="card-header pb-0">
                    <h6 class="mb-0 mt-2 d-flex align-items-center">
                        {{ module.title }}
                        <span class="ms-1 text-400" v-if="module.tooltip">
                        <span class="far fa-question-circle" data-bs-toggle="tooltip" :data-bs-placement="module.tooltipPosition" :title="module.tooltipText"></span>
                        </span>
                    </h6>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                        <p class="font-sans-serif lh-1 mb-1 fs-5">${{ module.value }}</p>
                        <span class="badge badge-subtle-success rounded-pill fs-11">{{ module.changePercentage }}</span>
                        </div>
                        <div class="col-auto ps-0">
                        <div :class="module.chartClass"></div>
                        </div>
                    </div>
                    </div>
                </div>
