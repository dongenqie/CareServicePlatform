...
export default {
  ...
  methods: {
    ...
    goToCalendar() {
    this.$router.push({ name: 'Calendar' })  // 跳转到 Calendar 页
    }
  },
  mounted() {
    // 1. RTL 模式
            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                  ...
                  </div><!-- parent pages--><a class="nav-link" @click="goToCalendar" href="" role="button">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-calendar-alt"></span></span><span class="nav-link-text ps-1">工作日历</span></div>
