...
data() {
  return {
    dashboardModules: [
      { id: 1, title: 'Module 1', value: '$47K', header: 'Module Header 1' },
      { id: 2, title: 'Module 2', value: '$30K', header: 'Module Header 2' },
      { id: 3, title: 'Module 3', value: '$15K', header: 'Module Header 3' },
      { id: 4, title: 'Module 4', value: '$10K', header: 'Module Header 4' },
    ]
  };
}
      ...
      <div class="container" data-layout="container">
        ...
        <div class="content">
          ...
          <!-- 使用vuedraggable包裹需要排序的模块 -->
            <draggable :list="dashboardModules" group="dashboard" :move="onMove" item-class="drag-item">
            <template v-slot:item="{ element }">
                <div class="col-md-6 col-xxl-3">
                <div class="card h-md-100 ecommerce-card-min-width">
                    <div class="card-header pb-0">
                    <h6 class="mb-0 mt-2">{{ element.header }}</h6>
                    </div>
                    <div class="card-body d-flex flex-column justify-content-end">
                    <div class="row">
                        <div class="col">
                        <p class="font-sans-serif lh-1 mb-1 fs-5">{{ element.value }}</p>
                        </div>
