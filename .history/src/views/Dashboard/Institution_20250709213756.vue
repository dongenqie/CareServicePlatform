                  ...
                  <ul class="nav nav-tabs border-0 chart-tab flex-nowrap" id="audience-chart-tab" role="tablist">
                    <li class="nav-item" role="presentation"><a class="nav-link mb-0 active" id="users-tab" data-bs-toggle="tab" href="#users" role="tab" aria-controls="users" aria-selected="true">
                        <div class="audience-tab-item p-2 pe-4">
                          <h6 class="text-800 fs-11 text-nowrap">Datas</h6>
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link mb-0" id="sessions-tab" data-bs-toggle="tab" href="#sessions" role="tab" aria-controls="sessions" aria-selected="false">
                        <div class="audience-tab-item p-2 pe-4">
                          <h6 class="text-800 fs-11 text-nowrap">risk record</h6>
                    ...
                    <div class="col">
                      <div class="row align-items-center">
                        <div class="col col-lg-8">
                          <h5 class="fs-9 mb-3 mb-sm-0 text-primary">Multi-party health data statistics and predictive analysis</h5>
                        </div>
            ...
            <div class="col-md-6 col-xxl-4">
              <div class="card h-100 bg-line-chart-gradient">
                <div class="card-header bg-transparent" data-bs-theme="light">
                  <h5 class="text-white">real-update Datas</h5>
                ...
                <div class="card-body text-white fs-10 pb-0" data-bs-theme="light">
                  <p class="border-bottom pb-2" style="border-color: rgba(255, 255, 255, 0.15) !important">Datas uploaded / second</p><!-- Find the JS file for the following chart at: src/js/charts/echarts/real-time-users.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js-->
                        ...
                        <tr>
                          <td class="py-3">
                            <div class="d-flex align-items-center"><img src="../assets/img/icons/chrome-logo.png" alt="" width="16" />
                              <h6 class="text-600 mb-0 ms-2">Api call</h6>
                            </div>
                          </td>
                          <td class="py-3">
                        ...
                        <tr>
                          <td class="py-3">
                            <div class="d-flex align-items-center"><img src="../assets/img/icons/safari-logo.png" alt="" width="16" />
                              <h6 class="text-600 mb-0 ms-2">Manual search</h6>
                            </div>
                          </td>
                          <td class="py-3">
                        ...
                        <tr>
                          <td class="py-3">
                            <div class="d-flex align-items-center"><img src="../assets/img/icons/firefox-logo.png" alt="" width="16" />
                              <h6 class="text-600 mb-0 ms-2">crawler</h6>
                            </div>
                          </td>
                          <td class="py-3">
            ...
            <div class="col-md-6 col-xxl-4">
              <div class="card">
                <div class="card-header d-flex align-items-center bg-body-tertiary py-2">
                  <h6 class="mb-0 flex-1">regional data</h6>
                ...
                <div class="card-body p-0">
                  <div class="scrollbar-overlay pt-0 px-x1 ask-analytics">
                    <div class="border border-1 border-300 rounded-2 p-3 ask-analytics-item position-relative mb-3">
                      ...
                      <h5 class="fs-10 text-800">Can this system help me analyze my health data?</h5>
                    </div>
                    <div class="border border-1 border-300 rounded-2 p-3 ask-analytics-item position-relative mb-3">
                      ...
                      <h5 class="fs-10 text-800">What is the basis for the system to analyze health data? Is it reliable?</h5>
                    </div>
                    <div class="border border-1 border-300 rounded-2 p-3 ask-analytics-item position-relative mb-3">
                      ...
                      <h5 class="fs-10 text-800">Can the overall health situation of the residents in a certain area be obtained through the system?</h5>
                    </div>
                    <div class="border border-1 border-300 rounded-2 p-3 ask-analytics-item position-relative mb-3">
                      ...
                      <h5 class="fs-10 text-800">Will the system alert me if my health data is abnormal?</h5>
                    </div>
                  </div>
                </div>
        ...
        <div class="row g-3 mb-3">
          <div class="col-lg-7 d-flex flex-column align-items-stretch">
            <div class="card mb-3 h-100">
              <div class="card-header d-flex flex-between-center bg-body-tertiary py-2">
                <h6 class="mb-0">User's willingness to use</h6>
                  ...
                  <div class="col-md-auto mt-md-0">
                    <div class="row flex-md-column justify-content-between h-md-100 ms-0">
                      <div class="col border-end border-end-md-0 border-bottom-md pt-3">
                        <h6 class="fs-11 text-700"><span class="fas fa-circle text-primary me-2"></span>total</h6>
                        <h5 class="text-700 fs-9">580</h5>
                      </div>
                      <div class="col border-end border-end-md-0 border-bottom-md pt-3 pt-md-4">
                        <h6 class="fs-11 text-700"><span class="fas fa-circle text-success me-2"></span>mobile terminal</h6>
                        <h5 class="text-700 fs-9">4,23</h5>
                      </div>
                      <div class="col pt-3 pt-md-4">
                        <h6 class="fs-11 text-700"><span class="fas fa-circle text-info me-2"></span>web</h6>
          ...
          <div class="col-lg-5">
            <div class="card h-100">
              <div class="card-header d-flex flex-between-center bg-body-tertiary py-2">
                <h6 class="mb-0">The effect of health intervention measures</h6>
              ...
              <div class="card-body pb-0">
                <div class="row">
                  <div class="col-6">
                    <div>
                      <h6 class="text-700">Cover users</h6>
                ...
                <div class="mx-nx1">
                  <div class="table-responsive scrollbar">
                    <table class="table fs-10 mb-0 overflow-hidden">
                      <thead class="bg-100">
                        <tr>
                          <th class="text-800 text-nowrap">intervening measure</th>
                          <th class="text-800 text-nowrap text-end">participants</th>
                          <th class="text-800 text-nowrap text-end">improvement rate</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td class="text-truncate">aerobic exercise</td>
                          <td class="text-truncate text-end">1,840</td>
                          <td class="text-truncate text-end">78.3%</td>
                        </tr>
                        <tr>
                          <td class="text-truncate">low salt diet</td>
                          <td class="text-truncate text-end">1,250</td>
                          <td class="text-truncate text-end">65.2%</td>
                        </tr>
                        <tr>
                          <td class="text-truncate">Cervical vertebrae relaxation</td>
                          <td class="text-truncate text-end">2,820</td>
                          <td class="text-truncate text-end">52.1%</td>
                        </tr>
                        <tr>
                          <td class="text-truncate">Drink at least 1.5 liters of water daily</td>
          ...
          <div class="col-lg-5 col-xxl-4">
            <div class="card">
              <div class="card-header bg-body-tertiary py-3">
                <h6 class="mb-0">User time prediction</h6>
              </div>
              ...
              <div class="card-header">
                <div class="row flex-between-center">
                  <div class="col-auto col-sm-6 col-lg-7">
                    <h6 class="mb-0 text-nowrap py-2 py-xl-0">top pages prediction</h6>
                  </div>
