          ...
          <div class="chat-box mb-3" style="max-height: 300px; overflow-y: auto;">
            <div class="chat-message user-message mb-2">
              <div class="d-flex justify-content-end">
                <span class="bg-primary text-white rounded p-2">{{ aiInput }}</span>
              </div>
            </div>
            <div v-if="aiResponse" class="chat-message ai-message mb-2">
              <div class="d-flex justify-content-start">
                <span class="bg-light text-dark rounded p-2">{{ aiResponse }}</span>
              </div>
            </div>
          </div>

          <!-- 输入框区域 -->
          <div class="input-area d-flex justify-content-between">
            <textarea
              v-model="aiInput"
              class="form-control mb-2"
              rows="3"
