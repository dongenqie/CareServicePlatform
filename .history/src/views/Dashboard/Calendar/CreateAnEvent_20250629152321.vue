            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <ul class="nav collapse show" id="calendar">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" @click="goToCreateAnEvent" href="">
                      <div class="d-flex active align-items-center"><span class="nav-link-text ps-1">Create an event</span></div>
                    </a><!-- more inner pages-->
                  </li>
                  <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="events">
                    <li class="nav-item"><a class="nav-link active" href="../../app/events/create-an-event.html">
            ...
            <div class="col-lg-8 pe-lg-2">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body bg-body-tertiary"><button class="btn btn-falcon-default btn-sm" type="button">Free<span class="d-none d-sm-inline"> Ticket</span></button><button class="btn btn-falcon-primary btn-sm ms-2" type="button">Paid<span class="d-none d-sm-inline"> Ticket</span></button><button class="btn btn-falcon-default btn-sm ms-2" type="button">Donation</button>
                  ...
                  <div class="scrollbar">
                    <table class="table table-bordered table-responsive overflow-hidden border-200 mt-3 bg-body-emphasis">
                      <thead>
                        <tr class="fs-10">
                          <th>Option Name</th>
                          <th>Price</th>
                      ...
                      <tbody>
                        <tr>
                          <td><input class="form-control form-control-sm" type="text" placeholder="Option Name" value="Front desks" style="min-width: 7.5rem;" /></td>
                          <td>
                            <div class="input-group input-group-sm" style="min-width: 7.5rem;"><span class="d-none d-sm-block input-group-text">$</span><input class="form-control form-control-sm input-spin-none" type="number" placeholder="Price" value="0" /></div>
                          </td>
                        ...
                        <tr>
                          <td><input class="form-control form-control-sm" type="text" placeholder="Option Name" value="Green gallery" style="min-width: 7.5rem;" /></td>
                          <td>
                            <div class="input-group input-group-sm" style="min-width: 7.5rem;"><span class="d-none d-sm-block input-group-text">$</span><input class="form-control form-control-sm input-spin-none" type="number" placeholder="Price" value="5" /></div>
                          </td>
                          <td class="text-center align-middle">
                        ...
                        <tr>
                          <td><input class="form-control form-control-sm" type="text" placeholder="VIP" value="VIP" style="min-width: 7.5rem;" /></td>
                          <td>
                            <div class="input-group input-group-sm" style="min-width: 7.5rem;"><span class="d-none d-sm-block input-group-text">$</span><input class="form-control form-control-sm input-spin-none" type="text" placeholder="Price" value="20" /></div>
                          </td>
                          <td class="text-center align-middle">
