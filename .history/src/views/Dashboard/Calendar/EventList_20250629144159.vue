            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <ul class="nav collapse show" id="calendar">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" @click="goToEventList" href="">
                  ...
                  <ul class="nav collapse show" id="events">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../../app/events/event-list.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Event list</span></div>
                      </a><!-- more inner pages--></li>
              ...
              <div class="row">
                <div class="col-md-6 h-100">
                  <div class="d-flex btn-reveal-trigger">
                    ...
                    <div class="flex-1 position-relative ps-3">
                      <h6 class="fs-9 mb-0"><a href="../../app/events/event-detail.html">Crain's New York Business <span class="badge badge-subtle-success rounded-pill">Free</span></a></h6>
                ...
                <div class="col-md-6 h-100">
                  <div class="d-flex btn-reveal-trigger">
                    ...
                    <div class="flex-1 position-relative ps-3">
                      <h6 class="fs-9 mb-0"><a href="../../app/events/event-detail.html">Film Festival</a></h6>
