          ...
          <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
              ...
              <li class="nav-item"><!-- label-->
                ...
                <!-- parent pages-->
                 <a class="nav-link active dropdown-indicator" @click="goToCalendar" href="#calendar" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="calendar">
              ...
              <li class="nav-item"><!-- label-->
                ...
                <ul class="nav collapse" id="components">
                  ...
                  <li class="nav-item"><a class="nav-link" @click="goToCalendar" href="">
