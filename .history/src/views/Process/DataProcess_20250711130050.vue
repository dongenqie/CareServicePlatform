              ...
              <div class="navbar-vertical-content scrollbar">
                <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                  ...
                  <li v-if="isResearcher" class="nav-item"><!-- label-->
                    ...
                    <!-- parent pages:数据处理-->
                    <a class="nav-link active" @click="goToDataProcess" href="" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="tables">
                      ...
                      <div class="sticky-sidebar">
                          <div class="card mb-lg-0">
                              ...
                              <div class="card-body bg-body-tertiary">
                                  ...
                                  <button class="btn btn-primary mb-2 float-end" @click="handleCleanExport">清洗并导出</button>
