            ...
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                <div class="row flex-between-center mb-2">
                  ...
                  <div class="col-auto fs-10 text-600"><span class="mb-0 undefined">or</span> <span ><a @click="goToRegister" style="color: #2C7BE5;border-bottom: 1cap;">Create an account</a></span></div>
                </div>
                <form>
