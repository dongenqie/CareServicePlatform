...
export default {
    ...
    methods: {
      goToDashboard() {
      this.$router.push({ name: 'Dashboard' })  // 跳转到 Dashboard 页
      },
      goToRegister() {
      this.$router.push({ name: 'Register' })  // 跳转到 Register 页
      },
      goToForgotPassword() {
      this.$router.push({ name: 'ForgotPassword' })  // 跳转到 ForgotPassword 页
      }
    },
    mounted() {
      // 切换 container 布局
                ...
                <div class="row g-0 h-100">
                  <div class="col-md-5 text-center bg-card-gradient">
                    ...
                    <div class="mt-3 mb-4 mt-md-4 mb-md-5" data-bs-theme="light">
                      <p class="text-white">Don't have an account?<br><a class="text-decoration-underline link-light" @click="goToRegister" href="">Get started!</a></p>
                    ...
                    <div class="p-4 p-md-5 flex-grow-1">
                      <div class="row flex-between-center">
                                ...
                                <div class="">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item"><a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#tab-profile" role="tab" aria-controls="tab-profile" aria-selected="false">审核员</a></li>
                                            <li class="nav-item"><a class="nav-link" id="contact-tab" data-bs-toggle="tab" href="#tab-contact" role="tab" aria-controls="tab-contact" aria-selected="false">管理员</a></li>
                                        </ul>
                                        <div class="tab-content border-top-0 p-3" id="myTabContent">
                                            <div class="tab-pane fade show active" id="tab-home" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="mb-3">
                                                    <label class="form-label" for="card-username">Username</label><input class="form-control" id="card-username" type="username" />
                                                </div>
                                                <div class="mb-3">
                                        ...
                                        <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-9771da1d-01c4-463d-8b16-27a335386f80" id="dom-9771da1d-01c4-463d-8b16-27a335386f80"><pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;ul class=&quot;nav nav-tabs&quot; id=&quot;myTab&quot; role=&quot;tablist&quot;&gt;
                        ...
                        <div class="row flex-between-center">
                          ...
                          <div class="col-auto"><a class="fs-10" @click="goToForgotPassword" href="">Forgot Password?</a></div>
                        </div>
