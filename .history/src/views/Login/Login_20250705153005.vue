...
// 存储当前选择的角色
const selectedRole = ref('RESEARCHER');  // 默认为研究员
                              ...
                              <div class="">
                                  ...
                                  <div class="tab-content">
                                      ...
                                      <ul class="nav nav-tabs" id="myTab" role="tablist">
                                          <li class="nav-item">
                                            <a class="nav-link active" :class="{ active: selectedRole === 'RESEARCHER' }" @click="handleRoleChange('RESEARCHER')" id="home-tab" data-bs-toggle="tab" href="#tab-home" role="tab" aria-controls="tab-home" aria-selected="true">研究员</a></li>
                                          <li class="nav-item"><a class="nav-link" :class="{ active: selectedRole === 'REVIEWER' }" @click="handleRoleChange('REVIEWER')" id="profile-tab" data-bs-toggle="tab" href="#tab-profile" role="tab" aria-controls="tab-profile" aria-selected="false">审核员</a></li>
                                          <li class="nav-item"><a class="nav-link" :class="{ active: selectedRole === 'ADMIN' }" @click="handleRoleChange('ADMIN')" id="contact-tab" data-bs-toggle="tab" href="#tab-contact" role="tab" aria-controls="tab-contact" aria-selected="false">管理员</a></li>
                                      </ul>
                                      <div class="tab-content border-top-0 p-3" id="myTabContent">
                                          <div class="tab-pane fade show active" id="tab-home" role="tabpanel" aria-labelledby="home-tab">
                                              <div class="mb-3">
                                                  ...
                                                  <input class="form-control" v-model="username" id="card-username" type="text" />
                                              </div>
                                              <div class="mb-3">
                                                  <div class="d-flex justify-content-between">
                                                    <label class="form-label" for="card-password">Password</label>
                                                  </div>
                                                  <input class="form-control" v-model="password" id="card-password" type="password" />
                                              </div>
                                          </div>
                                          <div class="tab-pane fade" id="tab-profile" role="tabpanel" aria-labelledby="profile-tab">
                                              <div class="mb-3">
                                                  <label class="form-label" for="card-username">Username</label>
                                                  <input class="form-control" v-model="username" id="card-username" type="username" />
                                              </div>
                                              <div class="mb-3">
                                                  <div class="d-flex justify-content-between">
