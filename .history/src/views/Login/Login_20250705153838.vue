                              ...
                              <div class="">
                                  ...
                                  <div class="tab-content">
                                      ...
                                      <ul class="nav nav-tabs" id="myTab" role="tablist">
                                          ...
                                          <li class="nav-item">
                                            <a class="nav-link" :class="{ active: selectedRole === 'REVIEWER' }" @click="handleRoleChange('REVIEWER')" id="profile-tab" data-bs-toggle="tab" href="#tab-profile" role="tab" aria-controls="tab-profile" aria-selected="false">审核员</a></li>
                                          <li class="nav-item">
                                            <a class="nav-link" :class="{ active: selectedRole === 'ADMIN' }" @click="handleRoleChange('ADMIN')" id="contact-tab" data-bs-toggle="tab" href="#tab-contact" role="tab" aria-controls="tab-contact" aria-selected="false">管理员</a></li>
                                      </ul>
