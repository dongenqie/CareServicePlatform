                ...
                <div class="row g-0 h-100">
                  <div class="col-md-5 text-center bg-card-gradient">
                    ...
                    <div class="mt-3 mb-4 mt-md-4 mb-md-5" data-bs-theme="light">
                      <p class="pt-3 text-white">已有账号?<br><a class="btn btn-outline-light mt-2 px-4" @click="goToLogin" href="">登录</a></p>
                    </div>
                  </div>
                  <!-- 注册表单 -->
                    ...
                    <div class="p-4 p-md-5 flex-grow-1">
                      ...
                      <div v-if="errorMsg" class="alert alert-danger py-2">{{ errorMsg }}</div>
                                        ...
                                        <div class="tab-content border-top-0 p-3" id="myTabContent">
                                            <div class="tab-pane fade show active" id="tab-home" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="mb-1">
                                                  ...
                                                  <input class="form-control" v-model="form.username" type="text" autocomplete="username" id="card-name" /></div>
                                                <div class="mb-1">
                        ...
                        <div class="form-check mt-2">
                          ...
                          <label class="form-label" for="card-register-checkbox">I accept the <a href="#!">terms </a>and <a class="white-space-nowrap" href="#!">privacy policy</a></label></div>
                        <div class="mb-3">
                          <button class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit">Register</button></div>
                      </form>
                    </div>
                  </div>
                </div>
