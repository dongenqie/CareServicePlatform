      ...
      <div class="row flex-center min-vh-100 py-6">
        <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
          <a class="d-flex flex-center mb-4" href="../../../index.html">
            <img class="me-2" src="../../assets/img/logo.png" alt="" width="54" />
            <span class="font-sans-serif text-primary fw-bolder fs-4 d-inline-block">健康大数据中心</span>
          </a>
          <div class="card">
            <div class="card-body p-4 p-sm-5">
              <div class="row flex-between-center mb-2">
                ...
                <div class="col-auto fs-10 text-600">
                  ...
                  <span><a href="../../../pages/authentication/simple/register.html">Create an account</a></span>
                </div>
              </div>
              <form>
                <div class="mb-3">
                ...
                <div class="row flex-between-center">
                  ...
                  <div class="col-auto">
                    <a class="fs-10" href="../../../pages/authentication/simple/forgot-password.html">Forgot Password?</a>
                  </div>
                </div>
                <div class="mb-3">
