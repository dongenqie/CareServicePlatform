      ...
      <div class="container"><a class="navbar-brand" href=""><span class="text-primary dark__text-white">健康大数据研究中心</span></a><button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarStandard" aria-controls="navbarStandard" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse scrollbar" id="navbarStandard">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item"><a class="nav-link" id="navbarDropdownLogin" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" @click="goToLogin">Login</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row flex-center pt-8 pt-lg-10 pb-lg-9 pb-xl-0">
          <div class="col-md-11 col-lg-8 col-xl-4 pb-7 pb-xl-9 text-center text-xl-start">
            ...
            <p class="lead text-white opacity-75">欢迎来到健康大数据研究中心</p><a class="btn btn-outline-light border-2 rounded-pill btn-lg mt-4 fs-9 py-2" href="#!">开始吧!<span class="fas fa-play ms-2" data-fa-transform="shrink-6 down-1"></span></a>
          </div>
