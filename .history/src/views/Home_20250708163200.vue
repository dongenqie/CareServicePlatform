...
<template>
  ...
  <main class="main" id="top">
    ...
    <section class="py-0 overflow-hidden" id="banner" data-bs-theme="light">
      <div class="bg-holder overlay" style="background-image:url(https://prium.github.io/falcon/v3.24.0/assets/img/generic/bg-3.jpg);background-position: center bottom;"></div><!--/.bg-holder-->
      <div class="container">
