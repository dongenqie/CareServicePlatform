...
<template>
  ...
  <main class="main" id="top">
    <nav class="navbar navbar-standard navbar-vibrant navbar-expand-lg fixed-top" data-navbar-darken-on-scroll="data-navbar-darken-on-scroll" style="background-color: linear-gradient(-45deg, rgba(0, 160, 255, 0.86), #0048a2);">
      <div class="container"><a class="navbar-brand" href=""><span class="text-primary dark__text-white">健康大数据研究中心</span></a><button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarStandard" aria-controls="navbarStandard" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse scrollbar" id="navbarStandard">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item "><a class="nav-link text-black" id="navbarDropdownLogin" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" @click="goToLogin">Login</a>
            </li>
          </ul>
        </div>
      </div>
