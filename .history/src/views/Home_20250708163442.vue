...
<template>
  ...
  <main class="main" id="top">
    ...
    <section class="py-0 overflow-hidden" id="banner" data-bs-theme="light">
      <div class="bg-holder overlay" style="background-image:url(https://tse2.mm.bing.net/th/id/OIP.ZDcZWKxnvZxCS-JdFp4E2wHaEK?rs=1&pid=ImgDetMain&o=7&rm=3);background-position: center bottom;"></div><!--/.bg-holder-->
      <div class="container">
