                ...
                <div class="card-header">
                  <div class="row flex-between-end">
                    <div class="col-auto align-self-center">
                      <h5 class="mb-0" data-anchor="data-anchor" id="heatmap-chart">Heatmap Chart<a class="anchorjs-link " aria-label="Anchor" data-anchorjs-icon="#" href="#heatmap-chart" style="margin-left: 0.1875em; padding-right: 0.1875em; padding-left: 0.1875em;"></a></h5>
                    </div>
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-290f85ff-d6a6-4ad1-9e21-859d6a9f8127" type="button" role="tab" aria-controls="dom-290f85ff-d6a6-4ad1-9e21-859d6a9f8127" aria-selected="true" id="tab-dom-290f85ff-d6a6-4ad1-9e21-859d6a9f8127">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-c9ec2811-0667-4021-ad8a-d5c7c39fde29" type="button" role="tab" aria-controls="dom-c9ec2811-0667-4021-ad8a-d5c7c39fde29" aria-selected="false" id="tab-dom-c9ec2811-0667-4021-ad8a-d5c7c39fde29" tabindex="-1">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-290f85ff-d6a6-4ad1-9e21-859d6a9f8127" id="dom-290f85ff-d6a6-4ad1-9e21-859d6a9f8127"><!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/heatmap-chart.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js-->
                      <div class="echart-heatmap-chart-example" style="min-height: 350px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); position: relative;" data-echart-responsive="true" _echarts_instance_="ec_1751827199120"><div style="position: relative; width: 381px; height: 350px; padding: 0px; margin: 0px; border-width: 0px; cursor: default;"><canvas data-zr-dom-id="zr_0" width="762" height="700" style="position: absolute; left: 0px; top: 0px; width: 381px; height: 350px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas></div><div class="" style="position: absolute; display: block; border-style: solid; white-space: nowrap; z-index: 9999999; box-shadow: rgba(0, 0, 0, 0.2) 1px 2px 10px; transition: opacity 0.2s cubic-bezier(0.23, 1, 0.32, 1), visibility 0.2s cubic-bezier(0.23, 1, 0.32, 1), transform 0.4s cubic-bezier(0.23, 1, 0.32, 1); background-color: rgb(249, 250, 253); border-width: 1px; border-radius: 4px; color: rgb(11, 23, 39); font: 14px / 21px &quot;Microsoft YaHei&quot;; padding: 7px 10px; top: 0px; left: 0px; transform: translate3d(6px, 159px, 0px); border-color: rgb(216, 226, 239); pointer-events: none; visibility: hidden; opacity: 0;"><div style="margin: 0px 0 0;line-height:1;"><div style="margin: 0px 0 0;line-height:1;"><span style="display:inline-block;margin-right:4px;border-radius:10px;width:10px;height:10px;background-color:rgba(23,197,201,1);"></span><span style="font-size:14px;color:#0b1727;font-weight:400;margin-left:2px">12a</span><span style="float:right;margin-left:20px;font-size:14px;color:#0b1727;font-weight:900">7</span><div style="clear:both"></div></div><div style="clear:both"></div></div><div style="position:absolute;width:6px;height:6px;z-index:-1;left:50%;bottom:-4.21px;transform:translateX(-50%) rotate(45deg);border-bottom:#d8e2ef solid 1px;border-right:#d8e2ef solid 1px;background-color:#f9fafd;"></div></div></div>
                    </div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-c9ec2811-0667-4021-ad8a-d5c7c39fde29" id="dom-c9ec2811-0667-4021-ad8a-d5c7c39fde29"><pre class="scrollbar rounded-1 language-html" style="max-height:420px" tabindex="0"><code class="language-html">
<span class="token comment">&lt;!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/heatmap-chart.js--&gt;</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>echart-heatmap-chart-example<span class="token punctuation">"</span></span> <span class="token special-attr"><span class="token attr-name">style</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span><span class="token value css language-css"><span class="token property">min-height</span><span class="token punctuation">:</span> 350px<span class="token punctuation">;</span></span><span class="token punctuation">"</span></span></span> <span class="token attr-name">data-echart-responsive</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>true<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span></code></pre>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6">
              <div class="card h-100" dir="ltr">
                <div class="card-header">
                  <div class="row flex-between-end">
                    <div class="col-auto align-self-center">
                      <h5 class="mb-0" data-anchor="data-anchor" id="heatmap-single-series-chart">Heatmap Single Series Chart<a class="anchorjs-link " aria-label="Anchor" data-anchorjs-icon="#" href="#heatmap-single-series-chart" style="margin-left: 0.1875em; padding-right: 0.1875em; padding-left: 0.1875em;"></a></h5>
                    </div>
                    <div class="col-auto ms-auto">
                      <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist"><button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-cd61b4c2-5447-49b9-9e0d-75d5b20592c8" type="button" role="tab" aria-controls="dom-cd61b4c2-5447-49b9-9e0d-75d5b20592c8" aria-selected="true" id="tab-dom-cd61b4c2-5447-49b9-9e0d-75d5b20592c8">Preview</button><button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-2c38d64e-d5f0-4938-baa4-c322fc0839bd" type="button" role="tab" aria-controls="dom-2c38d64e-d5f0-4938-baa4-c322fc0839bd" aria-selected="false" id="tab-dom-2c38d64e-d5f0-4938-baa4-c322fc0839bd" tabindex="-1">Code</button></div>
                    </div>
                  </div>
                </div>
                <div class="card-body bg-body-tertiary">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-cd61b4c2-5447-49b9-9e0d-75d5b20592c8" id="dom-cd61b4c2-5447-49b9-9e0d-75d5b20592c8"><!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/heatmap-single-series-chart.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js-->
                      <div class="echart-heatmap-single-series-chart" style="min-height: 350px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); position: relative;" data-echart-responsive="true" _echarts_instance_="ec_1751827199121"><div style="position: relative; width: 381px; height: 350px; padding: 0px; margin: 0px; border-width: 0px; cursor: pointer;"><canvas data-zr-dom-id="zr_0" width="762" height="700" style="position: absolute; left: 0px; top: 0px; width: 381px; height: 350px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas></div><div class="" style="position: absolute; display: block; border-style: solid; white-space: nowrap; z-index: 9999999; box-shadow: rgba(0, 0, 0, 0.2) 1px 2px 10px; transition: opacity 0.2s cubic-bezier(0.23, 1, 0.32, 1), visibility 0.2s cubic-bezier(0.23, 1, 0.32, 1), transform 0.4s cubic-bezier(0.23, 1, 0.32, 1); background-color: rgb(249, 250, 253); border-width: 1px; border-radius: 4px; color: rgb(11, 23, 39); font: 14px / 21px &quot;Microsoft YaHei&quot;; padding: 7px 10px; top: 0px; left: 0px; transform: translate3d(38px, 146px, 0px); border-color: rgb(216, 226, 239); pointer-events: none; visibility: hidden; opacity: 0;"><div style="margin: 0px 0 0;line-height:1;"><div style="margin: 0px 0 0;line-height:1;"><span style="display:inline-block;margin-right:4px;border-radius:10px;width:10px;height:10px;background-color:rgba(43,136,234,1);"></span><span style="font-size:14px;color:#0b1727;font-weight:400;margin-left:2px">2a</span><span style="float:right;margin-left:20px;font-size:14px;color:#0b1727;font-weight:900">8</span><div style="clear:both"></div></div><div style="clear:both"></div></div><div style="position:absolute;width:6px;height:6px;z-index:-1;left:50%;bottom:-4.21px;transform:translateX(-50%) rotate(45deg);border-bottom:#d8e2ef solid 1px;border-right:#d8e2ef solid 1px;background-color:#f9fafd;"></div></div></div>
                    </div>
                    <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-2c38d64e-d5f0-4938-baa4-c322fc0839bd" id="dom-2c38d64e-d5f0-4938-baa4-c322fc0839bd"><pre class="scrollbar rounded-1 language-html" style="max-height:420px" tabindex="0"><code class="language-html">
<span class="token comment">&lt;!-- Find the JS file for the following chart at: src/js/charts/echarts/examples/heatmap-single-series-chart.js--&gt;</span>
<span class="token comment">&lt;!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/echarts-example.js--&gt;</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>echart-heatmap-single-series-chart<span class="token punctuation">"</span></span> <span class="token special-attr"><span class="token attr-name">style</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span><span class="token value css language-css"><span class="token property">min-height</span><span class="token punctuation">:</span> 350px<span class="token punctuation">;</span></span><span class="token punctuation">"</span></span></span> <span class="token attr-name">data-echart-responsive</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>true<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span></code></pre>
                    </div>
                  </div>
                </div>
              </div>
