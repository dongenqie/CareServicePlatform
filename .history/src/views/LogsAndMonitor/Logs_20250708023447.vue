...
import { getApplications, handleApplication } from '@/api/admin';
...
const currentIsApproved = ref(null);

// 列表数据
const applications = ref([]);

// 打开“操作理由”弹窗
function openModal(appId, isApprovedFlag) {
  currentAppId.value = appId;
  currentIsApproved.value = isApprovedFlag;
  operationReason.value = '';
  showModal.value = true;
  // 使用 Bootstrap JS 手动打开弹窗
...
function submitReason() {
  ...
  if (!reason) {
    return alert('操作理由不能为空');
  }
  handleApplication(currentAppId.value, currentIsApproved.value, reason)
    .then(res => {
      if (res.success) {
        alert('申请处理成功');
        closeModal();
                      ...
                      <div class="d-none" id="table-ticket-actions">
                        <div class="d-flex">
                          <select class="form-select form-select-sm" aria-label="Bulk actions">
                            <option selected="selected">申请已处理</option>
                            <option value="Refund">拒绝申请</option>
                            <option value="Delete">问题已记录，会尽快申请</option>
                        ...
                        <table class="table table-sm mb-0 fs-10 table-view-tickets">
                          <thead class="bg-body-tertiary">
                            <tr>
                              ...
                              <th class="text-800 sort align-middle ps-2" data-sort="client">用户</th>
                              <th class="text-800 sort align-middle" data-sort="subject" style="min-width:9.625rem">内容</th>
                              <th class="text-800 sort align-middle" data-sort="client">反馈时间</th>
                              <th class="text-800 sort align-middle" data-sort="status">状态</th>
                              <th class="text-800 sort align-middle w-100" data-sort="agent" style="max-width:10.625rem">处理操作</th>
                              <th class="text-800 sort align-middle" data-sort="client">处理时间</th>
                            </tr>
                          </thead>
                            ...
                            <tr>
                              ...
                              <td class="align-middle client white-space-nowrap pe-3 pe-xxl-4 ps-2">
                                <div class="d-flex align-items-center gap-2 position-relative">
                                  ...
                                  <h6 class="mb-0"><a class="stretched-link text-900" href="">Luke</a></h6>
                                </div>
                              </td>
                              <td class="align-middle subject py-2 pe-4"><a class="fw-semi-bold" href="../app/support-desk/tickets-preview.html">反馈登录问题</a></td>
                              <td class="align-middle client white-space-nowrap pe-3 pe-xxl-4 ps-2">
                                <div class="d-flex align-items-center gap-2 position-relative">
                                  <h6 class="mb-0"><a class="stretched-link text-900" href="">2025/7/2 16:43</a></h6>
                                </div>
                              </td>
                              <td class="align-middle status fs-9 pe-4"><small class="badge rounded badge-subtle-danger false">未处理</small></td>
                              <td class="align-middle agent">
                                <button class="btn btn-falcon-success me-1 mb-1 btn-sm" type="button">通过</button>
                                <button class="btn btn-falcon-danger me-1 mb-1 btn-sm" type="button">拒绝</button>
                              </td>
                              <td class="align-middle client white-space-nowrap pe-3 pe-xxl-4 ps-2">
                                <div class="d-flex align-items-center gap-2 position-relative">
                                  <h6 class="mb-0"><a class="stretched-link text-900" href="">---</a></h6>
                                </div>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td class="align-middle client white-space-nowrap pe-3 pe-xxl-4 ps-2">
                                <div class="d-flex align-items-center gap-2 position-relative">
                                  ...
                                  <h6 class="mb-0"><a class="stretched-link text-900" href="">Finley</a></h6>
                                </div>
                              </td>
                              <td class="align-middle subject py-2 pe-4"><a class="fw-semi-bold" href="">反馈系统问题</a></td>
                              <td class="align-middle client white-space-nowrap pe-3 pe-xxl-4 ps-2">
                                <div class="d-flex align-items-center gap-2 position-relative">
                                  <h6 class="mb-0"><a class="stretched-link text-900" href="">2025/7/2 16:43</a></h6>
                                </div>
                              </td>
                              <td class="align-middle status fs-9 pe-4"><small class="badge rounded badge-subtle-warning false">进行中</small></td>
                              <td class="align-middle agent">
                                <button class="btn btn-falcon-success me-1 mb-1 btn-sm" type="button">通过</button>
                                <button class="btn btn-falcon-danger me-1 mb-1 btn-sm" type="button">拒绝</button>
                              </td>
                            ...
                            <tr>
                              ...
                              <td class="align-middle client white-space-nowrap pe-3 pe-xxl-4 ps-2">
                                <div class="d-flex align-items-center gap-2 position-relative">
                                  ...
                                  <h6 class="mb-0"><a class="stretched-link text-900" href="">Emma Watson</a></h6>
                                </div>
                              </td>
                              <td class="align-middle subject py-2 pe-4"><a class="fw-semi-bold" href="">反馈系统问题</a></td>
                              <td class="align-middle client white-space-nowrap pe-3 pe-xxl-4 ps-2">
                              ...
                              <td class="align-middle status fs-9 pe-4"><small class="badge rounded badge-subtle-success false">已处理</small></td>
                              <td class="align-middle agent">
                                <button class="btn btn-falcon-success me-1 mb-1 btn-sm" type="button">通过</button>
                                <button class="btn btn-falcon-danger me-1 mb-1 btn-sm" type="button">拒绝</button>
                              </td>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="reasonModalLabel">请输入操作理由</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <textarea class="form-control" v-model="operationReason" rows="4" placeholder="请输入操作理由..."></textarea>
          </div>
