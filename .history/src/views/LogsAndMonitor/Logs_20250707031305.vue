                        ...
                        <table class="table table-sm mb-0 fs-10 table-view-tickets">
                          <thead class="bg-body-tertiary">
                            <tr>
                              ...
                              <th class="text-800 sort align-middle" data-sort="subject" style="min-width:15.625rem">内容</th>
                              <th class="text-800 sort align-middle" data-sort="client">反馈时间</th>
                              <th class="text-800 sort align-middle" data-sort="status">状态</th>
                              <th class="text-800 sort align-middle w-100" data-sort="agent" style="max-width:15.625rem">处理操作</th>
