...
// 跳转到修改研究员信息页面
function goToModifyResearcher(userId) {
  router.push({ name: 'ModifyResearcher', params: { id: userId } })
}
            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li v-if="isAuditor" class="nav-item"><!-- label-->
                  ...
                  <!-- parent pages:用户审核-->
                  <a class="nav-link active" @click="goToUserReview" href="" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="user">
                      ...
                      <tbody class="list" id="table-recent-leads-body">
                        <tr v-for="(researcher, index) in researcherList" :key="researcher.id"  class="hover-actions-trigger btn-reveal-trigger hover-bg-100">
                          ...
                          <td class="align-middle white-space-nowrap" >
                            <a class="text-800" href="" @click.prevent="goToModifyResearcher(researcher.id)">
                              <div class="d-flex align-items-center">
                          ...
                          <td class="align-middle text-center white-space-nowrap text-end position-relative">
                            <div class="hover-actions bg-100">
                              ...
                              <!--删除研究员信息按钮-->
                              <button class="btn icon-item rounded-3 me-2 fs-11 icon-item-sm" @click="removeResearcher(researcher.id)"><span class="far fa-comment">X</span></button>
                            </div>
