                    ...
                    <table class="table fs-10 mb-0">
                      <thead class="bg-200">
                        <tr>
                          ...
                          <th class="text-800 sort align-middle text-center" data-sort="role">角色</th>
                      ...
                      <tbody class="list" id="table-recent-leads-body">
                        <tr class="hover-actions-trigger btn-reveal-trigger hover-bg-100">
                          ...
                          <td class="align-middle text-center" style="max-width: 40px;">研究员</td>
                          <td class="align-middle text-center white-space-nowrap text-primary email"><a href="mailto:john@gmail.com">john@gmail.com</a></td>
                          <td class="align-middle text-center white-space-nowrap">12345678901</td>
                          <td class="align-middle text-center white-space-nowrap"><small class="badge fw-semi-bold rounded-pill status badge-subtle-success">在线</small></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger hover-bg-100">
                          ...
                          <td class="align-middle text-center">研究员</td>
                          <td class="align-middle text-center white-space-nowrap text-primary email"><a href="mailto:john@gmail.com">john@gmail.com</a></td>
                          <td class="align-middle text-center white-space-nowrap">12345678901</td>
                          <td class="align-middle text-center white-space-nowrap"><small class="badge fw-semi-bold rounded-pill status badge-subtle-secondary">离线</small></td>
                          <td class="align-middle text-center white-space-nowrap text-end position-relative">
                            <div class="hover-actions bg-100">
                              <button class="btn icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="far fa-edit"></span></button>
                              <button class="btn icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="far fa-comment"></span></button>
