...
// 获取研究员列表
export const getResearcherList = (params) => {
  return apiClient.get('/api/auditor/users', { params });
};

// 获取研究员详情
export const getResearcherDetail = (userId) => {
  return apiClient.get(`/api/auditor/users/${userId}`);
};

// 修改研究员信息
export const updateResearcher = (userId, data) => {
  return apiClient.put(`/api/auditor/users/${userId}`, data);
};

// 删除研究员
export const deleteResearcher = (userId) => {
  return apiClient.delete(`/api/auditor/users/${userId}`);
};
