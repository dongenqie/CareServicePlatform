...
//中国地图
var echartsChinaMapInit = function () {
  // 找到新的容器
  ...
  // 假数据：各省 GDP 或人口
  var data = [
    { name: '北京市', value: 42153 },
    { name: '天津市', value: 7562 },
    { name: '上海市', value: 6553875 },
    { name: '重庆市', value: 293102 },
    { name: '河北省', value: 33600 },
    { name: '河南省', value: 51736 },
    { name: '云南省', value: 3592254 },
    { name: '辽宁省', value: 914645 },
    { name: '黑龙江省', value: 635637 },
    { name: '湖南省', value: 1935312 },
    { name: '湖北省', value: 2435312 },
    { name: '四川省', value: 9914421 },
    { name: '陕西省', value: 1393911 },
    { name: '新疆维吾尔自治区', value: 1591254 },
    { name: '江苏省', value: 1285321 },
    { name: '浙江省', value: 6535740 },
    { name: '安徽省', value: 3074320 },
    { name: '江西省', value: 2883700 },
    { name: '广东省', value: 4389800 },
    { name: '广西壮族自治区', value: 4603500 },
    { name: '海南省', value: 1322063 },
    { name: '甘肃省', value: 5883145 },
    { name: '贵州省', value: 6642967 },
    { name: '山西省', value: 9884170 },
    { name: '福建省', value: 5374799 },
    { name: '山东省', value: 2988650 },
    { name: '宁夏回族自治区', value: 1002035 },
    { name: '西藏自治区', value: 1992035 },
    { name: '青海省', value: 1851600 },
    { name: '吉林省', value: 2754260 },
    { name: '内蒙古自治区', value: 1325821 },
    { name: '香港特别行政区', value: 2255821 },
    { name: '澳门特别行政区', value: 3755821 },
    { name: '台湾省', value: 1835821 },
  ];
...
var echartsScatterQuartetChartInit = function echartsScatterQuartetChartInit() {
  ...
  if ($scatterQuartetChartEl) {
    ...
    var dataAll = [[[10.0, 8.04], [8.0, 6.95], [13.0, 7.58], [9.0, 8.81], [11.0, 8.33], [14.0, 9.96], [6.0, 7.24], [4.0, 4.26], [12.0, 10.84], [7.0, 4.82], [5.0, 5.68]]];
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        color: [utils.getColor('success'), utils.getColor('warning'), utils.getColor('danger')],
        tooltip: {
          trigger: 'item',
          axisPointer: {
            type: 'none'
